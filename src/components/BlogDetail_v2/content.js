...
const content = (props) => {
    const showContent = props.data.content.map(val => {
		return (
    ...
    const showTags = props.data.tages.map(val => {
		return (
    ...
    return (
		...
		{/* <!-- Title --> */}
		<div class="bg-img1 size-a-18 how-overlay1" style={{backgroundImage: 'url(images/blog-detail-01.jpg)'}}>
